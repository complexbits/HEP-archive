...
Double_t sbrat = 10000000.;
Double_t nSigma = 0.001;
Double_t bgtau = 0.;
...
void likelihood_jh()
{
  ...
  for(Int_t i=0.;i<20.;i++){
    ...
    g1->SetPoint(i,fitpar[1],-(1-2*fitpar[3])/0.16);
    g1->SetPointError(i,fiterr[1],2*fiterr[3]/0.16);
    
    g2->SetPoint(i,fitpar[1],1.65*2*fiterr[3]/0.16);
  ...
  TFile var_dm("vardm-2.root", "recreate");
  a1.Write();
  var_dm.Close();
