...
// vary this between 0.1 and 0.4 in the varsig0196*.C's
...
void varsig0196_a()
{
  ...
  TCanvas *vardm = new TCanvas("vardm","varsig0196_a",800,400);
  vardm->Divide(2,1);
  ...
  TFile var_dm("varsig0196_a.root", "recreate");
  a1.Write();
  var_dm.Close();
