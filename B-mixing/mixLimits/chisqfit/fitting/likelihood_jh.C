...
void likelihood_jh()
{
  ...
  h4 = (TH1F*)f1->Get("h_unmixed_events");
    ...
    TF1 *f3 = new TF1("f3", lftmosc_plt_d, min, max, 7);
    TF1 *f4 = new TF1("f4", lftmosc_plt_d, min, max, 7);
    ...
    f3->SetParameter(4,1);
    f3->SetParameter(5,evtN);
    f3->SetParameter(6,binN);
    f4->SetParameter(4,-1);
    f4->SetParameter(5,evtN);
    f4->SetParameter(6,binN);
