...
void dstag::Loop()
{
  ...
  TH1F *h_unmixed_events = new TH1F("h_unmixed_events", "VPDL, U Evts", 50, -4., 15.);
  TH1F *h_mixed_events = new TH1F("h_mixed_events", "VPDL, M Evts", 50, -4., 15.);
  
  TH1F *h_ume_osci = new TH1F("h_ume_osci", "VPDL, U Evts (osci)", 50, -4., 15.);
  TH1F *h_me_osci = new TH1F("h_me_osci", "VPDL, M Evts (osci)", 50, -4., 15.);
  
  TH1F *all_events_vpdl = new TH1F("all_events_vpdl", "VPDL, All Evts", 50, -4., 15.);
  ...
  TF1 *ubfit3 = new TF1("ubfit3", lifetime_plt, min, max, 2);
