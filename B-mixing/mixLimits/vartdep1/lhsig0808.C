...
void lhsig0808()
{
  ...
  TCanvas *vardm = new TCanvas("vardm","lhsig0808",800,400);
  vardm->Divide(2,1);
  ...
  TFile var_dm("lhsig0808.root", "recreate");
  a1.Write();
  var_dm.Close();
