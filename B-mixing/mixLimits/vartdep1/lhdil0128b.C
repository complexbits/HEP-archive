...
Double_t dilmc = 0.128;
Double_t dilfit = 0.128;
...
void lhdil0128b()
{
  ...
  TCanvas *vardm = new TCanvas("vardm","lhdil0128b",800,400);
  vardm->Divide(2,1);
  ...
  TFile var_dm("lhdil0128b.root", "recreate");
  a1.Write();
  var_dm.Close();
