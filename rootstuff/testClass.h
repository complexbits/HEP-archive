...
// Thu Apr 29 20:38:45 2004 by ROOT version 4.00/02
...
#ifdef testClass_cxx
testClass::testClass(TTree *tree)
{
...
Int_t testClass::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t testClass::LoadTree(Int_t entry)
{
...
void testClass::Show(Int_t entry)
{
...
Int_t testClass::Cut(Int_t entry)
{
