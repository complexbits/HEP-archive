...
TF1 *fit = new TF1("fit","gaus(0)+pol3(3)",5,16);
 ...
 m_1_coll_080.Fit("fit");
 m_1_coll_100.Fit("fit");
 m_1_coll_125.Fit("fit");
 m_1_coll_150.Fit("fit");
 m_1_coll_175.Fit("fit");

 m_1_coll_200.Fit("fit");
 m_1_coll_225.Fit("fit");
 m_1_coll_250.Fit("fit");
 m_1_coll_275.Fit("fit");

 m_1_coll_300.Fit("fit");
 m_1_coll_325.Fit("fit");
 m_1_coll_350.Fit("fit");
 m_1_coll_375.Fit("fit");

 m_1_coll_400.Fit("fit");
 m_1_coll_425.Fit("fit");
 m_1_coll_450.Fit("fit");
 m_1_coll_475.Fit("fit");

 m_1_coll_500.Fit("fit");
 m_1_coll_525.Fit("fit");
 m_1_coll_550.Fit("fit");
 m_1_coll_575.Fit("fit");

 m_1_coll_600.Fit("fit");
 m_1_coll_625.Fit("fit");
 m_1_coll_650.Fit("fit");
 m_1_coll_675.Fit("fit");

 m_1_coll_700.Fit("fit");
 m_1_coll_725.Fit("fit");
 m_1_coll_750.Fit("fit");
 m_1_coll_775.Fit("fit");

 m_1_coll_800.Fit("fit");
 m_1_coll_825.Fit("fit");
 m_1_coll_850.Fit("fit");
 m_1_coll_875.Fit("fit");

 m_1_coll_900.Fit("fit");
 m_1_coll_925.Fit("fit");
 m_1_coll_950.Fit("fit");

 m_1_dlsig_3_0.Fit("fit");
 m_1_dlsig_3_2.Fit("fit");
 m_1_dlsig_3_4.Fit("fit");	
 m_1_dlsig_3_6.Fit("fit");	
 m_1_dlsig_3_8.Fit("fit");
 m_1_dlsig_4_0.Fit("fit");
 m_1_dlsig_4_2.Fit("fit");
 m_1_dlsig_4_4.Fit("fit");	
 m_1_dlsig_4_6.Fit("fit");
 m_1_dlsig_4_8.Fit("fit");
 m_1_dlsig_5_0.Fit("fit");
 m_1_dlsig_5_2.Fit("fit");
 m_1_dlsig_5_4.Fit("fit");	
 m_1_dlsig_5_6.Fit("fit");	
 m_1_dlsig_5_8.Fit("fit");
 m_1_dlsig_6_0.Fit("fit");
 ...
 m_2_coll_080.Fit("fit");
 m_2_coll_100.Fit("fit");
 m_2_coll_125.Fit("fit");
 m_2_coll_150.Fit("fit");
 m_2_coll_175.Fit("fit");

 m_2_coll_200.Fit("fit");
 m_2_coll_225.Fit("fit");
 m_2_coll_250.Fit("fit");
 m_2_coll_275.Fit("fit");

 m_2_coll_300.Fit("fit");
 m_2_coll_325.Fit("fit");
 m_2_coll_350.Fit("fit");
 m_2_coll_375.Fit("fit");

 m_2_coll_400.Fit("fit");
 m_2_coll_425.Fit("fit");
 m_2_coll_450.Fit("fit");
 m_2_coll_475.Fit("fit");

 m_2_coll_500.Fit("fit");
 m_2_coll_525.Fit("fit");
 m_2_coll_550.Fit("fit");
 m_2_coll_575.Fit("fit");

 m_2_coll_600.Fit("fit");
 m_2_coll_625.Fit("fit");
 m_2_coll_650.Fit("fit");
 m_2_coll_675.Fit("fit");

 m_2_coll_700.Fit("fit");
 m_2_coll_725.Fit("fit");
 m_2_coll_750.Fit("fit");
 m_2_coll_775.Fit("fit");

 m_2_coll_800.Fit("fit");
 m_2_coll_825.Fit("fit");
 m_2_coll_850.Fit("fit");
 m_2_coll_875.Fit("fit");

 m_2_coll_900.Fit("fit");
 m_2_coll_925.Fit("fit");
 m_2_coll_950.Fit("fit");

 m_2_dlsig_3_0.Fit("fit");
 m_2_dlsig_3_2.Fit("fit");
 m_2_dlsig_3_4.Fit("fit");	
 m_2_dlsig_3_6.Fit("fit");	
 m_2_dlsig_3_8.Fit("fit");
 m_2_dlsig_4_0.Fit("fit");
 m_2_dlsig_4_2.Fit("fit");
 m_2_dlsig_4_4.Fit("fit");	
 m_2_dlsig_4_6.Fit("fit");
 m_2_dlsig_4_8.Fit("fit");
 m_2_dlsig_5_0.Fit("fit");
 m_2_dlsig_5_2.Fit("fit");
 m_2_dlsig_5_4.Fit("fit");	
 m_2_dlsig_5_6.Fit("fit");	
 m_2_dlsig_5_8.Fit("fit");
 m_2_dlsig_6_0.Fit("fit");
