...
//     (Mon Jun  2 16:20:43 2003 by ROOT version3.05/00)
//   from TChain tree/
//////////////////////////////////////////////////////////
...
#ifdef jh_060203_cxx
jh_060203::jh_060203(TTree *tree)
{
...
Int_t jh_060203::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t jh_060203::LoadTree(Int_t entry)
{
...
void jh_060203::Init(TTree *tree)
{
...
void jh_060203::Show(Int_t entry)
{
...
Int_t jh_060203::Cut(Int_t entry)
{
