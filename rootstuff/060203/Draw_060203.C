...
TFile* lotsa_histos = new TFile("jh_060203.root", "read");
...
TCanvas *lo_mass_1 = new TCanvas("lo_mass_1", "m>0.5GeV: Kpt, Ksmt cuts.  Upper: Signal, Lower: S/B ratio", 600, 600, 600, 600);
...
lo_mass_1->Print("lo_mass_1.eps");

TCanvas *lo_mass_2 = new TCanvas("lo_mass_2", "m>0.5GeV: dl_sig, coll cuts.  Upper: Signal, Lower: S/B ratio", 600, 600, 600, 600);
...
lo_mass_2->Print("lo_mass_2.eps");

TCanvas *hi_mass_1 = new TCanvas("hi_mass_1", "m>1.0GeV: Kpt, Ksmt cuts.  Upper: Signal, Lower: S/B ratio", 600, 600, 600, 600);
...
hi_mass_1->Print("hi_mass_1.eps");

TCanvas *hi_mass_2 = new TCanvas("hi_mass_2", "m>1.0GeV: dl_sig, coll cuts.  Upper: Signal, Lower: S/B ratio", 600, 600, 600, 600);
...
hi_mass_2->Print("hi_mass_2.eps");

TCanvas *kpt = new TCanvas("kpt", "Kpt: upper: 0.5<Kpt<1.0GeV, Kpt>1.0Gev, lower: same, with B-mass cuts", 600, 600, 600, 600);
...
TCanvas *cuts = new TCanvas("cuts", "dl_sig, coll, ksmt cut dists for lo/hi Kpt. Upper: 0.5<Kpt<1.0Gev, Lower: Kpt>1.0Gev", 900,600,900,600);
...
TCanvas *muons = new TCanvas("muons", "Muon eta, pt", 600,600,600,600);
muons->Divide(2,2);
muons->cd(1);
mu1eta->Draw();
muons->cd(2);
