...
//     (Thu May 29 11:41:47 2003 by ROOT version3.05/00)
//   from TChain tree/
//////////////////////////////////////////////////////////
...
#ifdef jh_052903_cxx
jh_052903::jh_052903(TTree *tree)
{
...
Int_t jh_052903::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t jh_052903::LoadTree(Int_t entry)
{
...
void jh_052903::Init(TTree *tree)
{
...
void jh_052903::Show(Int_t entry)
{
...
Int_t jh_052903::Cut(Int_t entry)
{
