...
//     (Tue May 27 11:39:29 2003 by ROOT version3.05/00)
//   from TChain tree/
//////////////////////////////////////////////////////////
...
#ifdef jh_052703_cxx
jh_052703::jh_052703(TTree *tree)
{
...
Int_t jh_052703::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t jh_052703::LoadTree(Int_t entry)
{
...
void jh_052703::Init(TTree *tree)
{
...
void jh_052703::Show(Int_t entry)
{
...
Int_t jh_052703::Cut(Int_t entry)
{
