...
//     (Tue May 20 17:58:25 2003 by ROOT version3.05/00)
//   from TChain tree/
//////////////////////////////////////////////////////////
...
#ifdef jh_052003_cxx
jh_052003::jh_052003(TTree *tree)
{
...
Int_t jh_052003::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t jh_052003::LoadTree(Int_t entry)
{
...
void jh_052003::Init(TTree *tree)
{
...
void jh_052003::Show(Int_t entry)
{
...
Int_t jh_052003::Cut(Int_t entry)
{
