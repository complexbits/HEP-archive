...
//     (Fri Jan 17 14:53:31 2003 by ROOT version3.04/01)
//   from TChain tree/
//////////////////////////////////////////////////////////
...
#ifdef bjpsi_v6_2_cxx
bjpsi_v6_2::bjpsi_v6_2(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bjpsi_aa_62.root");

     if (!f) {
       f = new TFile("bjpsi_aa_62.root");
...
bjpsi_v6_2::~bjpsi_v6_2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bjpsi_v6_2::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t bjpsi_v6_2::LoadTree(Int_t entry)
{
...
void bjpsi_v6_2::Init(TTree *tree)
{
...
void bjpsi_v6_2::Show(Int_t entry)
{
...
Int_t bjpsi_v6_2::Cut(Int_t entry)
{
