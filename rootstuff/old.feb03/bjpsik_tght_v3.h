...
//     (Mon Jan  6 10:29:11 2003 by ROOT version3.04/01)
//   from TTree tree/B -> Psi + X
//   found on file: bjpsik_tght_v3.root
//////////////////////////////////////////////////////////


#ifndef bjpsik_tght_v3_h
#define bjpsik_tght_v3_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class bjpsik_tght_v3 {
   public :
...
#ifdef bjpsik_tght_v3_cxx
bjpsik_tght_v3::bjpsik_tght_v3(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dimu_set1-9.root");
// 	TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bjpsik_set6.root");
     if (!f) {
       f = new TFile("dimu_set1-9.root");
//	f = new TFile("bjpsik_set6.root");
     }
...
bjpsik_tght_v3::~bjpsik_tght_v3()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bjpsik_tght_v3::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t bjpsik_tght_v3::LoadTree(Int_t entry)
{
...
void bjpsik_tght_v3::Init(TTree *tree)
{
...
void bjpsik_tght_v3::Show(Int_t entry)
{
...
Int_t bjpsik_tght_v3::Cut(Int_t entry)
{
...
#endif // #ifdef bjpsik_tght_v3_cxx
