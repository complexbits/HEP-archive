...
TFile finished_data("histograms-filled.root","recreate");
 ...
 data_n_stuff TH1S *q025p = new TH1S("q025p", "Jet Charge r < .25 positive", 20, -1.1, 1.1);
  ...
  TH1S *bpsik_count_good = new TH1S("bpsik_count_good", "# of Reasonable B's for Events w/ at least 1 B", 40,0.,10);
