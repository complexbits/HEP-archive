...
// Thu Oct 27 14:24:33 2005 by ROOT version 4.03/02
...
public :
   ...
   Int_t           K0dimu_k0dmu1[50];
   Int_t           K0dimu_k0dmu2[50];
   Float_t         K0dimu_K0PVx[50];
   Float_t         K0dimu_K0PVy[50];
   Float_t         K0dimu_K0PVz[50];
...
Int_t kana_v2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t kana_v2::LoadTree(Long64_t entry)
{
...
void kana_v2::Show(Long64_t entry)
{
...
Int_t kana_v2::Cut(Long64_t entry)
{
